...
from HPOBench.hpobench.dependencies.ml.ml_benchmark_template import MLBenchmark
    ...
    def _get_fidelity_choices(ntrees_choice: str, subsample_choice: str) -> Tuple[Hyperparameter, Hyperparameter]:
        ...
        fidelity1 = dict(
            ...
            variable=CS.UniformIntegerHyperparameter(
                'n_estimators', lower=10, upper=1000, default_value=1000, log=False
            )
        )
        fidelity2 = dict(
            fixed=CS.Constant('subsample', value=1),
            variable=CS.UniformFloatHyperparameter(
                'subsample', lower=0.01, upper=1, default_value=1, log=False
            )
        )
