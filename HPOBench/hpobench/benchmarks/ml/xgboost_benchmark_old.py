...
import HPOBench.hpobench.util.rng_helper as rng_helper
from HPOBench.hpobench.abstract_benchmark import AbstractBenchmark
from HPOBench.hpobench.util.openml_data_manager import OpenMLHoldoutDataManager
...
class XGBoostBenchmark(AbstractBenchmark):
    ...
    def objective_function(self, configuration: Union[CS.Configuration, Dict],
        ...
        return {'val_accuarcy': float(1-val_loss),
                'cost': cost,
                'info': {'train_accuarcy': float(1-train_loss),
                         'fidelity': fidelity}
                }
    ...
    def objective_function_test(self, configuration: Union[CS.Configuration, Dict],
        ...
        return {'test_accuarcy': float(1-test_loss),
                'cost': cost,
